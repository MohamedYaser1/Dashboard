...
<div class="container mt-5" style="width: 580px;">
    <form method="POST" action="{{route('admins.update', $admin->id)}}" class="">
            ...
            <div class="col-5 g-3 align-items-center">
                ...
                <div class="row mt-2" style="width: 300px;">
                    <input type="text" name="email" id="TextInput" class="form-control"
                        placeholder="Enter Email Address" value="{{ $admin->email_address }}">
                </div>
        ...
        <div class="row mt-3 d-flex justify-content-center">
            <button type="submit" class="btn btn-success" style="width:250px">Update Admin</button>
        </div>
